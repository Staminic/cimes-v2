...
$output = '<input type="text" name="q" id="mod-finder-searchword' . $module->id . '" class="search-query input-medium form-control" size="'
	...
	. ' placeholder="' . JText::_('MOD_FINDER_SEARCH_VALUE') . '" aria-label="' . JText::_('MOD_FINDER_SEARCH_VALUE') . '"/>';
...
{
	$button = '<span class="input-group-btn"><button class="btn' . $suffix . ' finder' . '" type="submit" title="' . JText::_('MOD_FINDER_SEARCH_BUTTON') . '"><i class="fa fa-search d-flex align-items-center" aria-hidden="true"></i></button></span>';
...
<form id="mod-finder-searchform<?php echo $module->id; ?>" action="<?php echo JRoute::_($route); ?>" method="get" class="form-search">
	<div class="finder input-group input-group-sm<?php echo $suffix; ?>">
		<?php
